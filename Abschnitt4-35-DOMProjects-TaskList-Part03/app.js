/*TaskList Part 3: Persist To Local Storage*/
...
function getTasks() {
  ...
  if(localStorage.getItem("tasks") === null) {
    ...
    //localStorage can only storage string, so we have to use JSON to parse it out.
...
function removeTask(e) {
  if(e.target.parentElement.classList.contains("delete-item")) {
    ...
    //Remove from LocalStorage: passing the element
